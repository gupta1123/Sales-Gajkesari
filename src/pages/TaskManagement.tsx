...
const TaskManagement = () => {
    ...
    const renderTag = (value: string | null | undefined, type: string) => {
        ...
        switch (value.toLowerCase()) {
            case 'assigned':
                className += 'tag-assigned';
                break;
            case 'in progress':
                className += 'tag-in-progress';
                break;
            case 'completed':
            ...
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogContent className="sm:max-w-[425px]">
                    ...
                    <div className="flex justify-end">
                        ...
                        <Button onClick={createTask} className="ml-2">
                            Create Task
                        </Button>
                    </div>
                </DialogContent>
            ...
            <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
                <DialogContent className="sm:max-w-[425px]">
                        ...
                        <div className="grid gap-4 py-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => setEditTask({ ...editTask, assignedToId: parseInt(value) })}
                                >
                                    <SelectTrigger className="w-[280px]">
                                        <SelectValue placeholder="Select an employee" />
                                    </SelectTrigger>
                    ...
                    <div className="flex justify-end">
                        ...
                        <Button onClick={updateTask} className="ml-2">
                            Update Task
                        </Button>
                    </div>
                </DialogContent>
                                ...
                                tasks
                                    ...
                                    .map((task) => (
                                        <TableRow key={task.id}>
                                            ...
                                            <TableCell>{task.assignedToId}</TableCell>
                                            <TableCell>{renderTag(task.status, 'status')}</TableCell>
                                            <TableCell>{renderTag(task.priority, 'priority')}</TableCell>
                                            <TableCell>
                                                <Button onClick={() => { setEditTask(task); setIsEditModalOpen(true); }}>Edit</Button>
